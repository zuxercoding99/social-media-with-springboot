...
public record RegisterDto(
        ...
        @NotBlank(message = "El username es obligatorio") @Size(min = 5, max = 30, message = "El username debe tener entre 5 y 30 caracteres") @Pattern(regexp = "^[a-z0-9_]+$", message = "El username solo puede contener letras minúsculas, números y guiones bajos") String username,
